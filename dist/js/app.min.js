...
autoplay:3e3,loop:!0}),swiperHaberler=new Swiper(".basin-slide-container",{speed:400,nextButton:".swiper-haber-btn-next",prevButton:".swiper-haber-btn-prev",slidesPerView:3,spaceBetween:30,autoplay:2e3,loop:!0}),searchButon=".languages .search-btn",searchDiv=".search",closeButon=".close-search";$(searchButon).click(function(){$(searchDiv).addClass("opened")}),$(closeButon).click(function(){$(searchDiv).removeClass("opened")}),
//video
