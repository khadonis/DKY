...
//Slider
var activeClassTxt=".swiper-pagination-bullet-active .res",bullts=".swiper-pagination-bullet",swiper=new Swiper(".swiper-container",{direction:"vertical",watchSlidesProgress:!0,pagination:".swiper-pagination",paginationClickable:!0,keyboardControl:!0,effect:"fade",speed:1e3,loop:!0,autoplay:3e3,queueStartCallbacks:!0,onInit:function(e){setTimeout(function(){addTxt(1,"DKY Sahil"),addTxt(2,"DKY On"),addTxt(3,"DKY Kartal"),$(activeClassTxt).show()},500)},onAfterResize:function(e){addTxt(1,"DKY Sahil"),addTxt(2,"DKY On"),addTxt(3,"DKY Kartal"),$(activeClassTxt).show()},onSlideChangeStart:function(e){$(".res").hide(),$(activeClassTxt).show()}}),searchButon=".languages .search-btn",searchDiv=".search",closeButon=".close-search";$(searchButon).click(function(){$(searchDiv).addClass("opened")}),$(closeButon).click(function(){$(searchDiv).removeClass("opened")});
/*! sourceMappingURL=snazzy-info-window.min.js.map */
function test(t){for(i=0;i<t.length;i++){var e="https://www.google.com.tr/maps/dir//"+t[i][1]+","+t[i][2];marker=new google.maps.Marker({position:new google.maps.LatLng(t[i][1],t[i][2]),map:map,animation:google.maps.Animation.DROP,icon:new google.maps.MarkerImage(t[i][3])}),markers.push(marker),(infowindow=new SnazzyInfoWindow({marker:marker,content:"<div><h3>"+t[i][0]+'</h3><a target="_blank" href="'+e+'" >Yol Tarifi</a><a target="_self" href="'+t[i][4]+'" >Proje Detayı</a></div>',wrapperClass:"iw-container",placement:"top",callbacks:{afterOpen:function(){$(this.getWrapper()).addClass("active")}}})).open(),google.maps.event.addListener(marker,"click",function(){infowindow.open()})}}function setMapOnAll(t){for(var e=0;e<markers.length;e++)markers[e].setMap(t)}function clearMarkers(){setMapOnAll(null)}function runMap(t,e,s){$(t).click(function(i){infowindow.close(),map.setZoom(16),map.panTo(s),clearMarkers(),test(e),$(".dprojs li").removeClass("active"),$(t).addClass("active"),aktifs()})}function adcls(t){$(plli).eq(t).find("span").addClass("active")}function aktifs(){$(pli).eq(0).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(okul),adcls(resmiKurum),adcls(avm),adcls(yemek)),$(pli).eq(1).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(okul),adcls(resmiKurum),adcls(avm),adcls(ulasim),adcls(park),adcls(yemek)),$(pli).eq(2).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(okul),adcls(resmiKurum),adcls(avm),adcls(ulasim),adcls(cami),adcls(yemek),adcls(park)),$(pli).eq(3).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(okul),adcls(hastane),adcls(avm),adcls(yemek),adcls(ulasim),adcls(cami),adcls(resmiKurum)),$(pli).eq(4).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(avm),adcls(yemek),adcls(ulasim),adcls(resmiKurum)),$(pli).eq(5).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(avm),adcls(yemek),adcls(ulasim),adcls(resmiKurum),adcls(okul)),$(pli).eq(6).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(avm),adcls(yemek),adcls(ulasim),adcls(cami),adcls(okul),adcls(park)),$(pli).eq(7).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(avm),adcls(hastane),adcls(ulasim),adcls(yemek)),$(pli).eq(8).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(avm),adcls(ulasim),adcls(yemek),adcls(okul)),$(pli).eq(9).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(avm),adcls(ulasim),adcls(yemek),adcls(okul),adcls(resmiKurum),adcls(cami),adcls(hastane))}!function(t,e){if("function"==typeof define&&define.amd)define("SnazzyInfoWindow",["module","exports"],e);else if("undefined"!=typeof exports)e(module,exports);else{var s={exports:{}};e(s,s.exports),t.SnazzyInfoWindow=s.exports}}(this,function(t,e){"use strict";function s(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function i(t,e){if(!t)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!e||"object"!=typeof e&&"function"!=typeof e?t:e}function a(t,e){if("function"!=typeof e&&null!==e)throw new TypeError("Super expression must either be null or a function, not "+typeof e);t.prototype=Object.create(e&&e.prototype,{constructor:{value:t,enumerable:!1,writable:!0,configurable:!0}}),e&&(Object.setPrototypeOf?Object.setPrototypeOf(t,e):t.__proto__=e)}function o(t,e){t&&e&&Object.keys(e).forEach(function(s){t[s]=e[s]})}function l(t){var e={};return o(e,y),o(e,t),Object.keys(y).forEach(function(t){var s=y[t];if("object"===(void 0===s?"undefined":c(s))){var i={};o(i,s),o(i,e[t]),e[t]=i}}),e}function n(t,e){var s=/^(-{0,1}\.{0,1}\d+(\.\d+)?)[\s|\.]*(\w*)$/;if(t&&s.test(t)){var i=s.exec(t);return{value:1*i[1],units:i[3]||"px",original:t}}return e?n(e):{original:e}}function r(t,e){if(t){for(;t.firstChild;)t.removeChild(t.firstChild);e&&("string"==typeof e?t.innerHTML=e:t.appendChild(e))}}function p(t){return"top"===t?"bottom":"bottom"===t?"top":"left"===t?"right":"right"===t?"left":t}function h(t){return t.charAt(0).toUpperCase()+t.slice(1)}function d(t){if(void 0!==t&&null!==t&&google){if(t instanceof google.maps.LatLng)return t;if(void 0!==t.lat&&void 0!==t.lng)return new google.maps.LatLng(t)}return null}Object.defineProperty(e,"__esModule",{value:!0});var m=function(){function t(t,e){for(var s=0;s<e.length;s++){var i=e[s];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(t,i.key,i)}}return function(e,s,i){return s&&t(e.prototype,s),i&&t(e,i),e}}(),c="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t},u={h:"0px",v:"3px",blur:"6px",spread:"0px",color:"#000"},y={placement:"top",pointer:!0,openOnMarkerClick:!0,closeOnMapClick:!0,closeWhenOthersOpen:!1,showCloseButton:!0,panOnOpen:!0,edgeOffset:{top:20,right:20,bottom:20,left:20}},f=function(t){function e(t){s(this,e);var a=i(this,(e.__proto__||Object.getPrototypeOf(e)).call(this,t));a._html=null,a._opts=l(t),a._callbacks=a._opts.callbacks||{},a._marker=a._opts.marker,a._map=a._opts.map,a._position=d(a._opts.position),a._isOpen=!1,a._listeners=[],google&&a._marker&&a._opts.openOnMarkerClick&&a.trackListener(google.maps.event.addListener(a._marker,"click",function(){a.getMap()||a.open()}),!0),a._position&&!a._opts.offset&&(a._opts.offset={top:"0px",left:"0px"});var o=t.placement||a._opts.position;return("string"==typeof o||o instanceof String)&&(o=o.toLowerCase()),a._opts.placement="top"!==o&&"bottom"!==o&&"left"!==o&&"right"!==o?y.placement:o,void 0===(o=a._opts.position)||null===o||"string"==typeof o||o instanceof String||(a._opts.position=o),void 0!==a._opts.border&&!0!==a._opts.border||(a._opts.border={}),void 0===a._opts.pointer&&(a._opts.pointer=y.pointer),void 0!==a._opts.shadow&&!0!==a._opts.shadow||(a._opts.shadow={}),a}return a(e,t),m(e,[{key:"activateCallback",value:function(t){var e=this._callbacks[t];return e?e.apply(this):void 0}},{key:"trackListener",value:function(t,e){this._listeners.push({listener:t,persistent:e})}},{key:"clearListeners",value:function(t){google&&this._listeners&&(this._listeners.forEach(function(e){!t&&e.persistent||(google.maps.event.removeListener(e.listener),e.listener=null)}),this._listeners=this._listeners.filter(function(t){return null!=t.listener}))}},{key:"isOpen",value:function(){return this._isOpen}},{key:"open",value:function(){var t=this.activateCallback("beforeOpen");(void 0===t||t)&&(this._marker?this.setMap(this._marker.getMap()):this._map&&this._position&&this.setMap(this._map))}},{key:"close",value:function(){var t=this.activateCallback("beforeClose");(void 0===t||t)&&(this.clearListeners(),this.setMap(null))}},{key:"destroy",value:function(){this.getMap()&&this.setMap(null),this.clearListeners(!0)}},{key:"setContent",value:function(t){this._opts.content=t,this._html&&this._html.content&&r(this._html.content,t)}},{key:"setPosition",value:function(t){this._position=d(t),this._isOpen&&this._position&&(this.draw(),this.resize(),this.reposition())}},{key:"getWrapper",value:function(){return this._html?this._html.wrapper:null}},{key:"draw",value:function(){if(this.getMap()&&this._html&&(this._marker||this._position)){var t=this._opts.offset;t&&(t.left&&(this._html.wrapper.style.marginLeft=t.left),t.top&&(this._html.wrapper.style.marginTop=t.top));var e=this._opts.backgroundColor;if(e&&(this._html.contentWrapper.style.backgroundColor=e,this._opts.pointer&&(this._html.pointerBg.style["border"+h(this._opts.placement)+"Color"]=e)),this._opts.padding&&(this._html.contentWrapper.style.padding=this._opts.padding,this._opts.shadow&&(this._html.shadowFrame.style.padding=this._opts.padding)),this._opts.borderRadius&&(this._html.contentWrapper.style.borderRadius=this._opts.borderRadius,this._opts.shadow&&(this._html.shadowFrame.style.borderRadius=this._opts.borderRadius)),this._opts.fontSize&&(this._html.wrapper.style.fontSize=this._opts.fontSize),this._opts.fontColor&&(this._html.contentWrapper.style.color=this._opts.fontColor),this._opts.pointer&&!0!==this._opts.pointer&&(this._opts.shadow&&(this._html.shadowPointer.style.width=this._opts.pointer,this._html.shadowPointer.style.height=this._opts.pointer),this._html.pointerBorder&&(this._html.pointerBorder.style.borderWidth=this._opts.pointer),this._html.pointerBg.style.borderWidth=this._opts.pointer),this._opts.border){var s=0;if(void 0!==this._opts.border.width&&(s=n(this._opts.border.width,"0px"),this._html.contentWrapper.style.borderWidth=s.value+s.units),s=Math.round((this._html.contentWrapper.offsetWidth-this._html.contentWrapper.clientWidth)/2),s=n(s+"px","0px"),this._opts.pointer){var i=Math.min(this._html.pointerBorder.offsetHeight,this._html.pointerBorder.offsetWidth);i=n(i+"px","0px");var a=Math.round(s.value*(1.41421356237-1));a=Math.min(a,i.value),this._html.pointerBg.style.borderWidth=i.value-a+i.units;var o=h(p(this._opts.placement));this._html.pointerBg.style["margin"+o]=a+s.units,this._html.pointerBg.style[this._opts.placement]=-s.value+s.units}var l=this._opts.border.color;l&&(this._html.contentWrapper.style.borderColor=l,this._html.pointerBorder&&(this._html.pointerBorder.style["border"+h(this._opts.placement)+"Color"]=l))}if(this._opts.shadow){var r=this._opts.shadow,d=function(t){var e=r[t];return void 0!==e&&null!=e};if(d("h")||d("v")||d("blur")||d("spread")||d("color")){var m=n(r.h,u.h),c=n(r.v,u.v),y=n(r.blur,u.blur),f=n(r.spread,u.spread),_=r.color||u.color,g=function(t,e){return t+" "+e+" "+y.original+" "+f.original+" "+_};this._html.shadowFrame.style.boxShadow=g(m.original,c.original);var v=.7071067811865474*(m.value-c.value)+m.units,k=.7071067811865474*(m.value+c.value)+c.units;this._html.shadowPointerInner.style.boxShadow=g(v,k)}this._opts.shadow.opacity&&(this._html.shadowWrapper.style.opacity=this._opts.shadow.opacity)}var b=this.getProjection().fromLatLngToDivPixel(this._position||this._marker.position);b&&(this._html.floatWrapper.style.top=Math.floor(b.y)+"px",this._html.floatWrapper.style.left=Math.floor(b.x)+"px"),this._isOpen||(this._isOpen=!0,this.resize(),this.reposition(),this.activateCallback("afterOpen"),google&&google.maps.event.trigger(this.getMap(),"snazzy-info-window-opened",this))}}},{key:"onAdd",value:function(){var t=this;if(!this._html){var e=function(t,e){if(t&&e)for(var s=0;s<e.length;s++){var i=e[s];i&&(t.className&&(t.className+=" "),t.className+="si-"+i)}},s=function(){for(var t=arguments.length,s=Array(t),i=0;i<t;i++)s[i]=arguments[i];var a=document.createElement("div");return e(a,s),a};if(this._html={},this._html.wrapper=s("wrapper-"+this._opts.placement),this._opts.wrapperClass&&(this._html.wrapper.className+=" "+this._opts.wrapperClass),this._opts.border&&e(this._html.wrapper,["has-border"]),this._opts.shadow&&(this._html.shadowWrapper=s("shadow-wrapper-"+this._opts.placement),this._html.shadowFrame=s("frame","shadow-frame"),this._html.shadowWrapper.appendChild(this._html.shadowFrame),this._opts.pointer&&(this._html.shadowPointer=s("shadow-pointer-"+this._opts.placement),this._html.shadowPointerInner=s("shadow-inner-pointer-"+this._opts.placement),this._html.shadowPointer.appendChild(this._html.shadowPointerInner),this._html.shadowWrapper.appendChild(this._html.shadowPointer)),this._html.wrapper.appendChild(this._html.shadowWrapper)),this._html.contentWrapper=s("frame","content-wrapper"),this._html.content=s("content"),this._opts.content&&r(this._html.content,this._opts.content),this._opts.showCloseButton){if(this._opts.closeButtonMarkup){var i=document.createElement("div");r(i,this._opts.closeButtonMarkup),this._html.closeButton=i.firstChild}else this._html.closeButton=document.createElement("button"),this._html.closeButton.setAttribute("type","button"),this._html.closeButton.innerHTML="&#215;",e(this._html.closeButton,["close-button"]);this._html.contentWrapper.appendChild(this._html.closeButton)}this._html.contentWrapper.appendChild(this._html.content),this._html.wrapper.appendChild(this._html.contentWrapper),this._opts.pointer&&(this._opts.border&&(this._html.pointerBorder=s("pointer-"+this._opts.placement,"pointer-border-"+this._opts.placement),this._html.wrapper.appendChild(this._html.pointerBorder)),this._html.pointerBg=s("pointer-"+this._opts.placement,"pointer-bg-"+this._opts.placement),this._html.wrapper.appendChild(this._html.pointerBg)),this._html.floatWrapper=s("float-wrapper"),this._html.floatWrapper.appendChild(this._html.wrapper),this.getPanes().floatPane.appendChild(this._html.floatWrapper);var a=this.getMap();this.clearListeners(),this._opts.closeOnMapClick&&this.trackListener(google.maps.event.addListener(a,"click",function(){t.close()})),this._opts.closeWhenOthersOpen&&this.trackListener(google.maps.event.addListener(a,"snazzy-info-window-opened",function(e){t!==e&&t.close()})),google&&(this._previousWidth=null,this._previousHeight=null,this.trackListener(google.maps.event.addListener(a,"bounds_changed",function(){var e=a.getDiv(),s=e.offsetWidth,i=e.offsetHeight,o=t._previousWidth,l=t._previousHeight;null!==o&&null!==l&&o===s&&l===i||(t._previousWidth=s,t._previousHeight=i,t.resize())})),this._marker&&this.trackListener(google.maps.event.addListener(this._marker,"position_changed",function(){t.draw()})),this._opts.showCloseButton&&!this._opts.closeButtonMarkup&&this.trackListener(google.maps.event.addDomListener(this._html.closeButton,"click",function(e){e.cancelBubble=!0,e.stopPropagation&&e.stopPropagation(),t.close()})),["click","dblclick","rightclick","contextmenu","drag","dragend","dragstart","mousedown","mouseout","mouseover","mouseup","touchstart","touchend","touchmove","wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"].forEach(function(e){t.trackListener(google.maps.event.addDomListener(t._html.wrapper,e,function(t){t.cancelBubble=!0,t.stopPropagation&&t.stopPropagation()}))})),this.activateCallback("open")}}},{key:"onRemove",value:function(){if(this.activateCallback("close"),this._html){var t=this._html.floatWrapper.parentElement;t&&t.removeChild(this._html.floatWrapper),this._html=null}this._isOpen=!1,this.activateCallback("afterClose")}},{key:"getMapInnerBounds",value:function(){var t=this.getMap().getDiv().getBoundingClientRect(),e={top:t.top+this._opts.edgeOffset.top,right:t.right-this._opts.edgeOffset.right,bottom:t.bottom-this._opts.edgeOffset.bottom,left:t.left+this._opts.edgeOffset.left};return e.width=e.right-e.left,e.height=e.bottom-e.top,e}},{key:"reposition",value:function(){if(this._opts.panOnOpen&&this._html){var t=this.getMapInnerBounds(),e=this._html.wrapper.getBoundingClientRect(),s=0,i=0;t.left>=e.left?s=e.left-t.left:t.right<=e.right&&(s=e.left-(t.right-e.width)),t.top>=e.top?i=e.top-t.top:t.bottom<=e.bottom&&(i=e.top-(t.bottom-e.height)),0===s&&0===i||this.getMap().panBy(s,i)}}},{key:"resize",value:function(){if(this._html){var t=this.getMapInnerBounds(),e=t.width;void 0!==this._opts.maxWidth&&(e=Math.min(e,this._opts.maxWidth)),e-=this._html.wrapper.offsetWidth-this._html.content.offsetWidth,this._html.content.style.maxWidth=e+"px";var s=t.height;void 0!==this._opts.maxHeight&&(s=Math.min(s,this._opts.maxHeight)),s-=this._html.wrapper.offsetHeight-this._html.content.offsetHeight,this._html.content.style.maxHeight=s+"px"}}}]),e}(google.maps.OverlayView);e.default=f,t.exports=e.default});/*! Map Api Js Start*/
var dkyVizyon=[["DKY Kartal",40.9093863,29.1996109,"../../dist/images/pin.png","#dkyVizyonLink",1]],dkySahil=[["DKY Sahil",40.8944685,29.171256,"../../dist/images/pin.png","#dkySahilLink",1]],dkyOnKagithane=[["DKY On Kağıthane",41.085888,28.9703857,"../../dist/images/pin.png","#dkyOnKagithaneLink",1]],dkyGoztepe=[["DKY Cadde Göztepe 05",40.9801883,29.0653588,"../../dist/images/pin.png","#dkyGoztepeLink",1]],dkyBusiness=[["DKY Business Kartal",40.9090283,29.2100452,"../../dist/images/pin.png","#dkyBusinessLink",1]],dkyLokumEvler=[["Lokum Evler",40.8750308,29.3239722,"../../dist/images/pin.png","#dkyLokumEvlerLink",1]],dkyAda=[["DKY Ada",40.905396,29.185898,"../../dist/images/pin.png","#dkyAdaLink",1]],dkyBusinessTuzla=[["DKY Business Tuzla",40.847713,29.2967011,"../../dist/images/pin.png","#dkyBusinezzTuzlaLink",1]],dkyCaddeSuadiye=[["DKY Cadde Suadiye 12",40.96679,29.085285,"../../dist/images/pin.png","#dkyCaddeSuadiyeLink",1]],dkyCaddeErenkoy=[["DKY Cadde Erenköy 86",40.978263,29.073121,"../../dist/images/pin.png","#dkyCaddeErenkoyLink",1]],map=new google.maps.Map(document.getElementById("map"),{zoom:16,scrollwheel:!1,center:new google.maps.LatLng(dkySahil[0][1],dkySahil[0][2]),mapTypeId:google.maps.MapTypeId.ROADMAP,types:["hospital","school","shopping_mall","amusement_park","park","food","gym","mosque"],styles:[{featureType:"all",elementType:"geometry",stylers:[{color:"#25292e"}]},{featureType:"all",elementType:"labels.text.fill",stylers:[{gamma:.01},{lightness:20},{color:"#47546e"}]},{featureType:"all",elementType:"labels.text.stroke",stylers:[{saturation:-31},{lightness:-33},{weight:2},{gamma:"0.00"},{visibility:"off"}]},{featureType:"all",elementType:"labels.icon",stylers:[{visibility:"on"}]},{featureType:"administrative.country",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"administrative.province",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"administrative.locality",elementType:"all",stylers:[{visibility:"simplified"}]},{featureType:"administrative.locality",elementType:"labels.text.fill",stylers:[{lightness:"45"}]},{featureType:"administrative.locality",elementType:"labels.icon",stylers:[{visibility:"on"}]},{featureType:"administrative.neighborhood",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"administrative.land_parcel",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"landscape",elementType:"geometry",stylers:[{lightness:30},{saturation:30},{color:"#30363d"},{visibility:"on"}]},{featureType:"poi",elementType:"geometry",stylers:[{saturation:"0"},{lightness:"0"},{gamma:"0.30"},{weight:"0.01"},{visibility:"off"}]},{featureType:"poi.park",elementType:"geometry",stylers:[{lightness:"100"},{saturation:-20},{visibility:"simplified"},{color:"#32383d"}]},{featureType:"road",elementType:"geometry",stylers:[{lightness:10},{saturation:-30},{color:"#2a3037"}]},{featureType:"road",elementType:"geometry.stroke",stylers:[{saturation:"-100"},{lightness:"-100"},{gamma:"0.00"},{color:"#2a3037"}]},{featureType:"road",elementType:"labels",stylers:[{visibility:"on"}]},{featureType:"road",elementType:"labels.text",stylers:[{visibility:"on"},{color:"#575e6b"}]},{featureType:"road",elementType:"labels.text.stroke",stylers:[{visibility:"off"}]},{featureType:"road",elementType:"labels.icon",stylers:[{visibility:"on"},{weight:"1"},{gamma:"1"},{saturation:"100"},{lightness:"1"}]},{featureType:"road.highway",elementType:"geometry.fill",stylers:[{color:"#474b51"},{visibility:"on"},{weight:"0.78"}]},{featureType:"road.highway",elementType:"geometry.stroke",stylers:[{visibility:"off"},{weight:"1.06"}]},{featureType:"road.highway",elementType:"labels.icon",stylers:[{visibility:"on"},{saturation:"75"}]},{featureType:"road.highway.controlled_access",elementType:"labels.text",stylers:[{visibility:"on"}]},{featureType:"road.highway.controlled_access",elementType:"labels.icon",stylers:[{visibility:"on"},{hue:"#ff6600"},{lightness:"1"},{saturation:"100"},{gamma:"1"},{weight:"2.08"}]},{featureType:"road.arterial",elementType:"labels.icon",stylers:[{visibility:"on"}]},{featureType:"road.local",elementType:"labels.icon",stylers:[{hue:"#ff0000"},{visibility:"on"}]},{featureType:"transit",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"transit.station.airport",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"water",elementType:"all",stylers:[{lightness:-20},{color:"#35485f"}]}]}),marker,i,markers=[],infowindow;test(dkySahil),runMap(".dky-sahil-harbtn",dkySahil,{lat:dkySahil[0][1],lng:dkySahil[0][2]}),runMap(".dky-kartal-harbtn",dkyVizyon,{lat:dkyVizyon[0][1],lng:dkyVizyon[0][2]}),runMap(".dky-on-harbtn",dkyOnKagithane,{lat:dkyOnKagithane[0][1],lng:dkyOnKagithane[0][2]}),runMap(".dky-cadde-goztepe-harbtn",dkyGoztepe,{lat:dkyGoztepe[0][1],lng:dkyGoztepe[0][2]}),runMap(".dky-bsness-kartal-harbtn",dkyBusiness,{lat:dkyBusiness[0][1],lng:dkyBusiness[0][2]}),runMap(".dky-lokum-harbtn",dkyLokumEvler,{lat:dkyLokumEvler[0][1],lng:dkyLokumEvler[0][2]}),runMap(".dky-ada-harbtn",dkyAda,{lat:dkyAda[0][1],lng:dkyAda[0][2]}),runMap(".dky-bsness-tuzla-harbtn",dkyBusinessTuzla,{lat:dkyBusinessTuzla[0][1],lng:dkyBusinessTuzla[0][2]}),runMap(".dky-cadde-suadiye-harbtn",dkyCaddeSuadiye,{lat:dkyCaddeSuadiye[0][1],lng:dkyCaddeSuadiye[0][2]}),runMap(".dky-cadde-erenkoy-harbtn",dkyCaddeErenkoy,{lat:dkyCaddeErenkoy[0][1],lng:dkyCaddeErenkoy[0][2]});var pli=".dprojs li",plli=".dplaces li",hastane=0,okul=1,resmiKurum=2,avm=3,orman=4,ulasim=5,cami=6,park=7,yemek=8,spor=9;aktifs();