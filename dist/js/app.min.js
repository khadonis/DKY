...
//menu panel
function addTxt(e,t){$(bullts+":eq("+(e-1)+")").html('<div class="res">'+t+"</div>")}function linkOutSlide(e,t){e.each(function(i){e.eq(i).find("a").click(function(){t.slideTo(i)})})}
...
function resizes(e){$(e).each(function(){var e=$(this).width(),t=$(this).parent().width();$(this).height(e),$(this).parent().height(t),$(this).find("img").height(e)})}$(".menu-toggle").click(function(){$(".menu").toggleClass("opened"),$(this).toggleClass("active"),$(".header").toggleClass("static"),$(".krtl-header").toggleClass("static")});
//Sliders
...
autoplay:3e3,loop:!0}),swiperKrtl=new Swiper(".krtl-slider-container",{direction:"vertical",speed:400,nextButton:".swiper-krtl-btn-next",prevButton:".swiper-krtl-btn-prev",onSlideChangeStart:function(){$(".krtl-tnt-aciklama .head li").find("a").removeClass("active"),$(".krtl-tnt-aciklama .head li").eq(swiperKrtl.activeIndex).find("a").addClass("active")}}),swiperKrtlVideo=new Swiper(".krtl-video-slider-container",{speed:400,nextButton:".swiper-krtl-btn-next",prevButton:".swiper-krtl-btn-prev"}),swiperHaberler=new Swiper(".basin-slide-container",{speed:400,nextButton:".swiper-haber-btn-next",prevButton:".swiper-haber-btn-prev",slidesPerView:3,spaceBetween:30,autoplay:2e3,loop:!0,breakpoints:{767:{slidesPerView:1,spaceBetween:0},1023:{slidesPerView:2,spaceBetween:15}}});linkOutSlide($(".krtl-tnt-aciklama .head li"),swiperKrtl),linkOutSlide($(".krtl-tnt-aciklama .head li"),swiperKrtlVideo);
//search panel
