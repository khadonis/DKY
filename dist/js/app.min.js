...
//menu panel
function addTxt(e,i){$(bullts+":eq("+(e-1)+")").html('<div class="res">'+i+"</div>")}function linkOutSlide(e,i){e.each(function(t){e.eq(t).find("a").click(function(){i.slideTo(t)})})}
...
function resizes(e){$(e).each(function(){var e=$(this).width(),i=$(this).parent().width();$(this).height(e),$(this).parent().height(i),$(this).find("img").height(e)})}$(".menu-toggle").click(function(){$(".menu").toggleClass("opened"),$(this).toggleClass("active"),$(".header").toggleClass("static"),$(".krtl-header").toggleClass("static")});
//Sliders
var activeClassTxt=".swiper-pagination-bullet-active .res",bullts=".swiper-pagination-bullet",swiper=new Swiper(".swiper-container",{direction:"vertical",watchSlidesProgress:!0,pagination:".swiper-pagination",paginationClickable:!0,
//keyboardControl: true,
//effect: "fade",
speed:1e3,loop:!0,autoplay:3e3,queueStartCallbacks:!0,onInit:function(e){setTimeout(function(){addTxt(1,"DKY Sahil"),addTxt(2,"DKY On"),addTxt(3,"DKY Kartal"),$(activeClassTxt).show()},500)},onAfterResize:function(e){addTxt(1,"DKY Sahil"),addTxt(2,"DKY On"),addTxt(3,"DKY Kartal"),$(activeClassTxt).show()},onSlideChangeStart:function(e){$(".res").hide(),$(activeClassTxt).show()}}),swiperOduller=new Swiper(".odul-slide-container",{speed:400,
//nextButton: '.swiper-button-next',
//prevButton: '.swiper-button-prev',
autoplay:3e3,loop:!0}),swiperKrtl=new Swiper(".krtl-slider-container",{direction:"vertical",speed:400,nextButton:".swiper-krtl-btn-next",prevButton:".swiper-krtl-btn-prev",onSlideChangeStart:function(){$(".krtl-tnt-aciklama .head li").find("a").removeClass("active"),$(".krtl-tnt-aciklama .head li").eq(swiperKrtl.activeIndex).find("a").addClass("active")}}),swiperKrtlVideo=new Swiper(".krtl-video-slider-container",{speed:400,nextButton:".swiper-krtl-btn-next",prevButton:".swiper-krtl-btn-prev"}),swiperKrtlGaleri=new Swiper(".kartal-galeri-slider-container",{speed:400,effect:"fade",
//prevButton: '.kg-btn-prev',
//nextButton: '.kg-btn-next',
onSlideChangeStart:function(){$(".kartal-galeri .head div").find("a").removeClass("active"),$(".kartal-galeri .head div").eq(swiperKrtlGaleri.activeIndex).find("a").addClass("active")},spaceBetween:40,breakpoints:{425:{spaceBetween:0}}}),swiperKrtlMimari=new Swiper(".kg-mimari-slider-container",{speed:400,nextButton:".kg-btn-next",prevButton:".kg-btn-prev",spaceBetween:40}),swiperKrtlIcMimari=new Swiper(".kg-icmimari-slider-container",{speed:400,nextButton:".kg-btn-next",prevButton:".kg-btn-prev",spaceBetween:40}),swiperKrtlODaire=new Swiper(".kg-odaire-slider-container",{speed:400,nextButton:".kg-btn-next",prevButton:".kg-btn-prev",spaceBetween:40}),swiperKrtlPlans=new Swiper(".plans-slider-container",{speed:400,spaceBetween:40,onSlideChangeStart:function(){$("#plans li").find("a").removeClass("active"),$("#plans li").eq(swiperKrtlPlans.activeIndex).find("a").addClass("active"),$("#plansMobile li").find("a").removeClass("active"),$("#plansMobile li").eq(swiperKrtlPlans.activeIndex).find("a").addClass("active")}}),swiperKrtlPlan1=new Swiper(".plan-1-slide-container",{speed:400,
//direction:'vertical',
effect:"fade",spaceBetween:40,onSlideChangeStart:function(){$(".rooms li").find("a").removeClass("active"),$(".rooms li").eq(swiperKrtlPlan1.activeIndex).find("a").addClass("active")}}),swiperKrtlPlan2=new Swiper(".plan-2-slide-container",{speed:400,
//direction:'vertical',
effect:"fade",spaceBetween:40,onSlideChangeStart:function(){$(".rooms2 li").find("a").removeClass("active"),$(".rooms2 li").eq(swiperKrtlPlan2.activeIndex).find("a").addClass("active")}}),swiperKrtlPlan3=new Swiper(".plan-3-slide-container",{speed:400,
//direction:'vertical',
effect:"fade",spaceBetween:40,onSlideChangeStart:function(){$(".rooms3 li").find("a").removeClass("active"),$(".rooms3 li").eq(swiperKrtlPlan3.activeIndex).find("a").addClass("active")}}),swiperKrtlPlan4=new Swiper(".plan-4-slide-container",{speed:400,
//direction:'vertical',
effect:"fade",spaceBetween:40,onSlideChangeStart:function(){$(".rooms4 li").find("a").removeClass("active"),$(".rooms4 li").eq(swiperKrtlPlan4.activeIndex).find("a").addClass("active")}}),swiperHaberler=new Swiper(".basin-slide-container",{speed:400,nextButton:".swiper-haber-btn-next",prevButton:".swiper-haber-btn-prev",slidesPerView:3,spaceBetween:30,autoplay:2e3,loop:!0,breakpoints:{767:{slidesPerView:1,spaceBetween:0},1023:{slidesPerView:2,spaceBetween:15}}});linkOutSlide($(".krtl-tnt-aciklama .head li"),swiperKrtl),linkOutSlide($(".krtl-tnt-aciklama .head li"),swiperKrtlVideo),linkOutSlide($(".kartal-galeri .head div"),swiperKrtlGaleri),linkOutSlide($("#plans li"),swiperKrtlPlans),linkOutSlide($("#plansMobile li"),swiperKrtlPlans),linkOutSlide($(".rooms li"),swiperKrtlPlan1),linkOutSlide($(".rooms2 li"),swiperKrtlPlan2),linkOutSlide($(".rooms3 li"),swiperKrtlPlan3),linkOutSlide($(".rooms4 li"),swiperKrtlPlan4);
//search panel
var searchButon=".languages .search-btn",searchDiv=".search",closeButon=".close-search";$(searchButon).click(function(){$(searchDiv).addClass("opened")}),$(closeButon).click(function(){$(searchDiv).removeClass("opened")}),
//video
$(".video-wrapper .mask").click(function(e){$(".video").attr("src","https://www.youtube.com/embed/hAxZF94QFks?autoplay=1").siblings().hide()}),
//kurumsal side menu
$(window).width()>767&&$(".side-menu").height($(".content-inner").height()-60),$(function(){var e=location.pathname;$(".side-menu a").each(function(){var i=$(this),t=e.split(/[\s/]+/);
// if the current path is like this link, make it active
-1!==i.attr("href").indexOf(t[t.length-1])&&($(".side-menu a").removeClass("active"),i.addClass("active"))})}),resizes(".tp-box-field a"),$(window).resize(function(){resizes(".tp-box-field a")});
//yasal uyari
var yUyariDiv=$(".y-uyari"),yUyariBtn=$(".y-uyari-btn");yUyariBtn.click(function(){yUyariDiv.slideDown()}),
//bootstrap modal popup convert to lightbox
$("a.thumb").click(function(e){e.preventDefault();var i=$(this).attr("href"),t=$(".modal-body");t.empty(),t.html('<img src="'+i+'">'),$(".modal-profile").modal("{show:true}")});
