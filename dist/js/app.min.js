...
function updateGradient(){if(void 0!==$){var o=colors[colorIndices[0]],r=colors[colorIndices[1]],e=colors[colorIndices[2]],t=colors[colorIndices[3]],c=1-step,n="rgb("+Math.round(c*o[0]+step*r[0])+","+Math.round(c*o[1]+step*r[1])+","+Math.round(c*o[2]+step*r[2])+")",s="rgb("+Math.round(c*e[0]+step*t[0])+","+Math.round(c*e[1]+step*t[1])+","+Math.round(c*e[2]+step*t[2])+")";$(".gradient").css({background:"-webkit-gradient(linear, left top, right top, from("+n+"), to("+s+"))"}).css({background:"-moz-linear-gradient(left, "+n+" 0%, "+s+" 100%)"}),(step+=gradientSpeed)>=1&&(step%=1,colorIndices[0]=colorIndices[1],colorIndices[2]=colorIndices[3],colorIndices[1]=(colorIndices[1]+Math.floor(1+Math.random()*(colors.length-1)))%colors.length,colorIndices[3]=(colorIndices[3]+Math.floor(1+Math.random()*(colors.length-1)))%colors.length)}}var colors=new Array([29,43,62],[253,79,0],[29,43,62],[29,43,62]),step=0,colorIndices=[0,1,2,3],gradientSpeed=.002;setInterval(updateGradient,2);
/*! my custom javascript file */
function updateProgress(e){var i=parseInt(e.text(),10);if(100===i)return $("#loaderWr").hide(),i=0,!1;e.text(i+1+"%"),progress_loader.width(i+1+"%"),setTimeout(function(){updateProgress(e)},0),$(document).ready(function(){return!1})}function onYouTubeIframeAPIReady(){player=new YT.Player("video1",{height:"450",width:"585",videoId:videoId_1,events:{onReady:onPlayerReady}}),player2=new YT.Player("video2",{height:"450",width:"585",videoId:videoId_2,events:{onReady:onPlayerReady2}})}function onPlayerReady(e){$("#videoRun").click(function(){$(this).hide(),player.playVideo()})}function onPlayerReady2(e){$("#videoRun2").click(function(){$(this).hide(),player2.playVideo()})}function playVid(e){e.play()}function pauseVid(e){e.pause()}function addTxt(e,i){$(bullts+":eq("+(e-1)+")").html('<div class="res">'+i+"</div>")}function linkOutSlide(e,i){e.each(function(t){e.eq(t).find("a").click(function(){i.slideTo(t)})})}function resizes(e){$(e).each(function(){var e=$(this).width(),i=$(this).parent().width();$(this).height(e),$(this).parent().height(i),$(this).find("img:not(h4 img)").height(e)})}var progress=$("#loaderWr").find(".percentage"),progress_loader=$("#loaderWr").find(".loader div");updateProgress(progress),$(document).on("load",updateProgress,!1),$(window).scroll(function(){$(this).scrollTop()>=50?$(".header").addClass("shdw"):$(".header").removeClass("shdw")}),$(".menu-toggle").click(function(){$(".menu").toggleClass("opened"),$(this).toggleClass("active"),$(".header").toggleClass("static"),$(".krtl-header").toggleClass("static")});var player,player2,videoId_1="NBldK9HYe6k",videoId_2="NhsJY7Zf6cc",linkVideo="http://img.youtube.com/vi/"+videoId_1+"/0.jpg",linkVideo2="http://img.youtube.com/vi/"+videoId_2+"/0.jpg";$("#videoRun").css("background-image","url("+linkVideo+")"),$("#videoRun2").css("background-image","url("+linkVideo2+")");var vid=document.getElementById("video1"),vid2=document.getElementById("video2"),activeClassTxt=".swiper-pagination-bullet-active .res",bullts=".swiper-pagination-bullet",swiper=new Swiper(".swiper-container",{direction:"vertical",watchSlidesProgress:!0,pagination:".swiper-pagination",paginationClickable:!0,speed:1e3,loop:!0,autoplay:12e3,queueStartCallbacks:!0,onInit:function(e){},onAfterResize:function(e){},onSlideChangeStart:function(e){0==e.realIndex?playVid(vid):pauseVid(vid),1==e.realIndex?playVid(vid2):pauseVid(vid2)}}),swiperOduller=new Swiper(".odul-slide-container",{speed:400,autoplay:3e3,loop:!0}),swiperKrtl=new Swiper(".krtl-slider-container",{direction:"vertical",speed:400,nextButton:".swiper-krtl-btn-next",prevButton:".swiper-krtl-btn-prev"}),swiperKrtlVideo=new Swiper(".krtl-video-slider-container",{speed:400,nextButton:".swiper-krtl-btn-next",prevButton:".swiper-krtl-btn-prev",onSlideChangeStart:function(){$(".krtl-tnt-aciklama .head li").find("a").removeClass("active"),$(".krtl-tnt-aciklama .head li").eq(swiperKrtlVideo.activeIndex).find("a").addClass("active");var e=$("#videoRun").is(":hidden");0==swiperKrtlVideo.activeIndex&&e?player.playVideo():player.pauseVideo();var i=$("#videoRun2").is(":hidden");1==swiperKrtlVideo.activeIndex&&i?player2.playVideo():player2.pauseVideo()}}),swiperKrtlGaleri=new Swiper(".kartal-galeri-slider-container",{speed:400,effect:"fade",onSlideChangeStart:function(){$(".kartal-galeri .head div").find("a").removeClass("active"),$(".kartal-galeri .head div").eq(swiperKrtlGaleri.activeIndex).find("a").addClass("active")},spaceBetween:40,breakpoints:{425:{spaceBetween:0}}}),swiperKrtlMimari=new Swiper(".kg-mimari-slider-container",{speed:400,nextButton:".kg-btn-next",prevButton:".kg-btn-prev",spaceBetween:40}),swiperKrtlIcMimari=new Swiper(".kg-icmimari-slider-container",{speed:400,nextButton:".kg-btn-next",prevButton:".kg-btn-prev",spaceBetween:40}),swiperKrtlODaire=new Swiper(".kg-odaire-slider-container",{speed:400,nextButton:".kg-btn-next",prevButton:".kg-btn-prev",spaceBetween:40}),swiperKrtlPlans=new Swiper(".plans-slider-container",{speed:400,spaceBetween:40,onSlideChangeStart:function(){$("#plans li").find("a").removeClass("active"),$("#plans li").eq(swiperKrtlPlans.activeIndex).find("a").addClass("active"),$("#plansMobile li").find("a").removeClass("active"),$("#plansMobile li").eq(swiperKrtlPlans.activeIndex).find("a").addClass("active")}}),swiperKrtlPlan1=new Swiper(".plan-1-slide-container",{speed:400,effect:"fade",spaceBetween:40,onSlideChangeStart:function(){$(".rooms li").find("a").removeClass("active"),$(".rooms li").eq(swiperKrtlPlan1.activeIndex).find("a").addClass("active")}}),swiperKrtlPlan2=new Swiper(".plan-2-slide-container",{speed:400,effect:"fade",spaceBetween:40,onSlideChangeStart:function(){$(".rooms2 li").find("a").removeClass("active"),$(".rooms2 li").eq(swiperKrtlPlan2.activeIndex).find("a").addClass("active")}}),swiperKrtlPlan3=new Swiper(".plan-3-slide-container",{speed:400,effect:"fade",spaceBetween:40,onSlideChangeStart:function(){$(".rooms3 li").find("a").removeClass("active"),$(".rooms3 li").eq(swiperKrtlPlan3.activeIndex).find("a").addClass("active")}}),swiperKrtlPlan4=new Swiper(".plan-4-slide-container",{speed:400,effect:"fade",spaceBetween:40,onSlideChangeStart:function(){$(".rooms4 li").find("a").removeClass("active"),$(".rooms4 li").eq(swiperKrtlPlan4.activeIndex).find("a").addClass("active")}}),swiperHaberler=new Swiper(".basin-slide-container",{speed:400,nextButton:".swiper-haber-btn-next",prevButton:".swiper-haber-btn-prev",slidesPerView:3,spaceBetween:30,autoplay:2e3,loop:!0,breakpoints:{767:{slidesPerView:1,spaceBetween:0},1365:{slidesPerView:2,spaceBetween:15}}}),swiper=new Swiper(".ozellik-swiper-container",{nextButton:".ozellikler-krtl-btn-next",prevButton:".ozellikler-krtl-btn-prev"});linkOutSlide($(".krtl-tnt-aciklama .head li"),swiperKrtl),linkOutSlide($(".krtl-tnt-aciklama .head li"),swiperKrtlVideo),linkOutSlide($(".kartal-galeri .head div"),swiperKrtlGaleri),linkOutSlide($("#plans li"),swiperKrtlPlans),linkOutSlide($("#plansMobile li"),swiperKrtlPlans),linkOutSlide($(".rooms li"),swiperKrtlPlan1),linkOutSlide($(".rooms2 li"),swiperKrtlPlan2),linkOutSlide($(".rooms3 li"),swiperKrtlPlan3),linkOutSlide($(".rooms4 li"),swiperKrtlPlan4);var searchButon=".languages .search-btn",searchDiv=".search",closeButon=".close-search";$(searchButon).click(function(){$(searchDiv).addClass("opened")}),$(closeButon).click(function(){$(searchDiv).removeClass("opened")}),$(".video-wrapper .mask").click(function(e){$(".video").attr("src","https://www.youtube.com/embed/hAxZF94QFks?autoplay=1").siblings().hide()}),$(window).width()>767&&$(".side-menu").height($(".content-inner").height()-60),resizes(".tp-box-field a"),$(window).resize(function(){resizes(".tp-box-field a")});var yUyariDiv=$(".y-uyari"),yUyariBtn=$(".y-uyari-btn");yUyariBtn.click(function(){yUyariDiv.slideDown()}),$("a.thumb").click(function(e){e.preventDefault();var i=$(this).attr("href"),t=$(".modal-body");t.empty(),t.html('<img src="'+i+'">'),$(".modal-profile").modal("{show:true}")}),$("#myModal").modal("handleUpdate"),$("#myModal").on("show.bs.modal",function(){$(this).find(".modal-body").css({width:"auto",height:"auto","max-height":"100%"})}),$(document).ready(function(){function e(){$(".h-box iframe").each(function(){var e=$(this).height();e=$(this).width()/1.7,$(this).attr("height",e+30)})}setTimeout(e,10),$(window).resize(e)}),$(".nav-proj a").each(function(){$(this).click(function(e){e.preventDefault();var i=$(this).attr("href");i=$(i),$("html, body").animate({scrollTop:i.offset().top-60},2500)})}),$("a.gal-item").fancybox({transitionIn:"elastic",transitionOut:"elastic",speedIn:600,speedOut:200,padding:0,margin:0});
/*! sourceMappingURL=snazzy-info-window.min.js.map */
function test(e,t){for(i=0;i<e.length;i++){var s="https://www.google.com.tr/maps/dir//"+e[i][1]+","+e[i][2];marker=new google.maps.Marker({position:new google.maps.LatLng(e[i][1],e[i][2]),map:t,animation:google.maps.Animation.DROP,icon:new google.maps.MarkerImage(e[i][3])}),markers.push(marker),infowindow=new SnazzyInfoWindow({marker:marker,content:'<div class="mi-content"><div class="mi-image" style="background-image:url('+e[i][5]+');" ></div><a target="_blank" href="'+s+'" class="mi-tarif">Yol Tarifi</a><a href="'+e[i][4]+'" class="mi-detay">Proje Detayı</a></div>',wrapperClass:"iw-container",placement:"top",closeWhenOthersOpen:!0,callbacks:{afterOpen:function(){$(this.getWrapper()).addClass("active")}}}),google.maps.event.addListener(marker,"click",function(){null.open()})}}function setMapOnAll(e){for(var t=0;t<markers.length;t++)markers[t].setMap(e)}function clearMarkers(){setMapOnAll(null)}function runMap(e,t,s,i){$(e).click(function(a){$(".si-float-wrapper").remove(),clearMarkers(),infowindow.close(),map.setZoom(i),map.panTo(s),test(t,map),$(".proje-listesi a").removeClass("active"),$(".dprojs li").removeClass("active"),$(".vertical-h-menu a").removeClass("active"),$(e).addClass("active"),aktifs()})}function adcls(e){$(plli).eq(e).find("span").addClass("active")}function aktifs(){$(projeParentLink).each(function(){$(this).parent().siblings("ul").find("li a").hasClass("active")&&($(projeParentLink).removeClass("active"),$(this).addClass("active"),$(this).hasClass("tamamlanan-harbtn")&&$(".vertical-h-menu .tamamlanan-harbtn").addClass("active"),$(this).hasClass("devam-eden-harbtn")&&$(".vertical-h-menu .devam-eden-harbtn").addClass("active"),$(this).hasClass("gelecek-harbtn")&&$(".vertical-h-menu .gelecek-harbtn").addClass("active"))}),$(pli).eq(0).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(okul),adcls(resmiKurum),adcls(avm),adcls(yemek)),$(pli).eq(1).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(okul),adcls(resmiKurum),adcls(avm),adcls(ulasim),adcls(park),adcls(yemek)),$(pli).eq(2).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(okul),adcls(resmiKurum),adcls(avm),adcls(ulasim),adcls(cami),adcls(yemek),adcls(park)),$(pli).eq(3).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(okul),adcls(hastane),adcls(avm),adcls(yemek),adcls(ulasim),adcls(cami),adcls(resmiKurum)),$(pli).eq(4).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(avm),adcls(yemek),adcls(ulasim),adcls(resmiKurum)),$(pli).eq(5).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(avm),adcls(yemek),adcls(ulasim),adcls(resmiKurum),adcls(okul)),$(pli).eq(6).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(avm),adcls(yemek),adcls(ulasim),adcls(cami),adcls(okul),adcls(park)),$(pli).eq(7).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(avm),adcls(hastane),adcls(ulasim),adcls(yemek)),$(pli).eq(8).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(avm),adcls(ulasim),adcls(yemek),adcls(okul)),$(pli).eq(9).hasClass("active")&&($(plli+" span").removeClass("active"),adcls(avm),adcls(ulasim),adcls(yemek),adcls(okul),adcls(resmiKurum),adcls(cami),adcls(hastane))}!function(e,t){if("function"==typeof define&&define.amd)define("SnazzyInfoWindow",["module","exports"],t);else if("undefined"!=typeof exports)t(module,exports);else{var s={exports:{}};t(s,s.exports),e.SnazzyInfoWindow=s.exports}}(this,function(e,t){"use strict";function s(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){if(!e)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return!t||"object"!=typeof t&&"function"!=typeof t?e:t}function a(e,t){if("function"!=typeof t&&null!==t)throw new TypeError("Super expression must either be null or a function, not "+typeof t);e.prototype=Object.create(t&&t.prototype,{constructor:{value:e,enumerable:!1,writable:!0,configurable:!0}}),t&&(Object.setPrototypeOf?Object.setPrototypeOf(e,t):e.__proto__=t)}function o(e,t){e&&t&&Object.keys(t).forEach(function(s){e[s]=t[s]})}function n(e){var t={};return o(t,y),o(t,e),Object.keys(y).forEach(function(e){var s=y[e];if("object"===(void 0===s?"undefined":c(s))){var i={};o(i,s),o(i,t[e]),t[e]=i}}),t}function l(e,t){var s=/^(-{0,1}\.{0,1}\d+(\.\d+)?)[\s|\.]*(\w*)$/;if(e&&s.test(e)){var i=s.exec(e);return{value:1*i[1],units:i[3]||"px",original:e}}return t?l(t):{original:t}}function r(e,t){if(e){for(;e.firstChild;)e.removeChild(e.firstChild);t&&("string"==typeof t?e.innerHTML=t:e.appendChild(t))}}function p(e){return"top"===e?"bottom":"bottom"===e?"top":"left"===e?"right":"right"===e?"left":e}function h(e){return e.charAt(0).toUpperCase()+e.slice(1)}function d(e){if(void 0!==e&&null!==e&&google){if(e instanceof google.maps.LatLng)return e;if(void 0!==e.lat&&void 0!==e.lng)return new google.maps.LatLng(e)}return null}Object.defineProperty(t,"__esModule",{value:!0});var m=function(){function e(e,t){for(var s=0;s<t.length;s++){var i=t[s];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}return function(t,s,i){return s&&e(t.prototype,s),i&&e(t,i),t}}(),c="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},u={h:"0px",v:"3px",blur:"6px",spread:"0px",color:"#000"},y={placement:"top",pointer:!0,openOnMarkerClick:!0,closeOnMapClick:!0,closeWhenOthersOpen:!1,showCloseButton:!0,panOnOpen:!0,edgeOffset:{top:20,right:20,bottom:20,left:20}},f=function(e){function t(e){s(this,t);var a=i(this,(t.__proto__||Object.getPrototypeOf(t)).call(this,e));a._html=null,a._opts=n(e),a._callbacks=a._opts.callbacks||{},a._marker=a._opts.marker,a._map=a._opts.map,a._position=d(a._opts.position),a._isOpen=!1,a._listeners=[],google&&a._marker&&a._opts.openOnMarkerClick&&a.trackListener(google.maps.event.addListener(a._marker,"click",function(){a.getMap()||a.open()}),!0),a._position&&!a._opts.offset&&(a._opts.offset={top:"0px",left:"0px"});var o=e.placement||a._opts.position;return("string"==typeof o||o instanceof String)&&(o=o.toLowerCase()),a._opts.placement="top"!==o&&"bottom"!==o&&"left"!==o&&"right"!==o?y.placement:o,void 0===(o=a._opts.position)||null===o||"string"==typeof o||o instanceof String||(a._opts.position=o),void 0!==a._opts.border&&!0!==a._opts.border||(a._opts.border={}),void 0===a._opts.pointer&&(a._opts.pointer=y.pointer),void 0!==a._opts.shadow&&!0!==a._opts.shadow||(a._opts.shadow={}),a}return a(t,google.maps.OverlayView),m(t,[{key:"activateCallback",value:function(e){var t=this._callbacks[e];return t?t.apply(this):void 0}},{key:"trackListener",value:function(e,t){this._listeners.push({listener:e,persistent:t})}},{key:"clearListeners",value:function(e){google&&this._listeners&&(this._listeners.forEach(function(t){!e&&t.persistent||(google.maps.event.removeListener(t.listener),t.listener=null)}),this._listeners=this._listeners.filter(function(e){return null!=e.listener}))}},{key:"isOpen",value:function(){return this._isOpen}},{key:"open",value:function(){var e=this.activateCallback("beforeOpen");(void 0===e||e)&&(this._marker?this.setMap(this._marker.getMap()):this._map&&this._position&&this.setMap(this._map))}},{key:"close",value:function(){var e=this.activateCallback("beforeClose");(void 0===e||e)&&(this.clearListeners(),this.setMap(null))}},{key:"destroy",value:function(){this.getMap()&&this.setMap(null),this.clearListeners(!0)}},{key:"setContent",value:function(e){this._opts.content=e,this._html&&this._html.content&&r(this._html.content,e)}},{key:"setPosition",value:function(e){this._position=d(e),this._isOpen&&this._position&&(this.draw(),this.resize(),this.reposition())}},{key:"getWrapper",value:function(){return this._html?this._html.wrapper:null}},{key:"draw",value:function(){if(this.getMap()&&this._html&&(this._marker||this._position)){var e=this._opts.offset;e&&(e.left&&(this._html.wrapper.style.marginLeft=e.left),e.top&&(this._html.wrapper.style.marginTop=e.top));var t=this._opts.backgroundColor;if(t&&(this._html.contentWrapper.style.backgroundColor=t,this._opts.pointer&&(this._html.pointerBg.style["border"+h(this._opts.placement)+"Color"]=t)),this._opts.padding&&(this._html.contentWrapper.style.padding=this._opts.padding,this._opts.shadow&&(this._html.shadowFrame.style.padding=this._opts.padding)),this._opts.borderRadius&&(this._html.contentWrapper.style.borderRadius=this._opts.borderRadius,this._opts.shadow&&(this._html.shadowFrame.style.borderRadius=this._opts.borderRadius)),this._opts.fontSize&&(this._html.wrapper.style.fontSize=this._opts.fontSize),this._opts.fontColor&&(this._html.contentWrapper.style.color=this._opts.fontColor),this._opts.pointer&&!0!==this._opts.pointer&&(this._opts.shadow&&(this._html.shadowPointer.style.width=this._opts.pointer,this._html.shadowPointer.style.height=this._opts.pointer),this._html.pointerBorder&&(this._html.pointerBorder.style.borderWidth=this._opts.pointer),this._html.pointerBg.style.borderWidth=this._opts.pointer),this._opts.border){var s=0;if(void 0!==this._opts.border.width&&(s=l(this._opts.border.width,"0px"),this._html.contentWrapper.style.borderWidth=s.value+s.units),s=Math.round((this._html.contentWrapper.offsetWidth-this._html.contentWrapper.clientWidth)/2),s=l(s+"px","0px"),this._opts.pointer){var i=Math.min(this._html.pointerBorder.offsetHeight,this._html.pointerBorder.offsetWidth);i=l(i+"px","0px");var a=Math.round(s.value*(1.41421356237-1));a=Math.min(a,i.value),this._html.pointerBg.style.borderWidth=i.value-a+i.units;var o=h(p(this._opts.placement));this._html.pointerBg.style["margin"+o]=a+s.units,this._html.pointerBg.style[this._opts.placement]=-s.value+s.units}var n=this._opts.border.color;n&&(this._html.contentWrapper.style.borderColor=n,this._html.pointerBorder&&(this._html.pointerBorder.style["border"+h(this._opts.placement)+"Color"]=n))}if(this._opts.shadow){var r=this._opts.shadow,d=function(e){var t=r[e];return void 0!==t&&null!=t};if(d("h")||d("v")||d("blur")||d("spread")||d("color")){var m=l(r.h,u.h),c=l(r.v,u.v),y=l(r.blur,u.blur),f=l(r.spread,u.spread),g=r.color||u.color,_=function(e,t){return e+" "+t+" "+y.original+" "+f.original+" "+g};this._html.shadowFrame.style.boxShadow=_(m.original,c.original);var v=.7071067811865474*(m.value-c.value)+m.units,k=.7071067811865474*(m.value+c.value)+c.units;this._html.shadowPointerInner.style.boxShadow=_(v,k)}this._opts.shadow.opacity&&(this._html.shadowWrapper.style.opacity=this._opts.shadow.opacity)}var b=this.getProjection().fromLatLngToDivPixel(this._position||this._marker.position);b&&(this._html.floatWrapper.style.top=Math.floor(b.y)+"px",this._html.floatWrapper.style.left=Math.floor(b.x)+"px"),this._isOpen||(this._isOpen=!0,this.resize(),this.reposition(),this.activateCallback("afterOpen"),google&&google.maps.event.trigger(this.getMap(),"snazzy-info-window-opened",this))}}},{key:"onAdd",value:function(){var e=this;if(!this._html){var t=function(e,t){if(e&&t)for(var s=0;s<t.length;s++){var i=t[s];i&&(e.className&&(e.className+=" "),e.className+="si-"+i)}},s=function(){for(var e=arguments.length,s=Array(e),i=0;i<e;i++)s[i]=arguments[i];var a=document.createElement("div");return t(a,s),a};if(this._html={},this._html.wrapper=s("wrapper-"+this._opts.placement),this._opts.wrapperClass&&(this._html.wrapper.className+=" "+this._opts.wrapperClass),this._opts.border&&t(this._html.wrapper,["has-border"]),this._opts.shadow&&(this._html.shadowWrapper=s("shadow-wrapper-"+this._opts.placement),this._html.shadowFrame=s("frame","shadow-frame"),this._html.shadowWrapper.appendChild(this._html.shadowFrame),this._opts.pointer&&(this._html.shadowPointer=s("shadow-pointer-"+this._opts.placement),this._html.shadowPointerInner=s("shadow-inner-pointer-"+this._opts.placement),this._html.shadowPointer.appendChild(this._html.shadowPointerInner),this._html.shadowWrapper.appendChild(this._html.shadowPointer)),this._html.wrapper.appendChild(this._html.shadowWrapper)),this._html.contentWrapper=s("frame","content-wrapper"),this._html.content=s("content"),this._opts.content&&r(this._html.content,this._opts.content),this._opts.showCloseButton){if(this._opts.closeButtonMarkup){var i=document.createElement("div");r(i,this._opts.closeButtonMarkup),this._html.closeButton=i.firstChild}else this._html.closeButton=document.createElement("button"),this._html.closeButton.setAttribute("type","button"),this._html.closeButton.innerHTML="&#215;",t(this._html.closeButton,["close-button"]);this._html.contentWrapper.appendChild(this._html.closeButton)}this._html.contentWrapper.appendChild(this._html.content),this._html.wrapper.appendChild(this._html.contentWrapper),this._opts.pointer&&(this._opts.border&&(this._html.pointerBorder=s("pointer-"+this._opts.placement,"pointer-border-"+this._opts.placement),this._html.wrapper.appendChild(this._html.pointerBorder)),this._html.pointerBg=s("pointer-"+this._opts.placement,"pointer-bg-"+this._opts.placement),this._html.wrapper.appendChild(this._html.pointerBg)),this._html.floatWrapper=s("float-wrapper"),this._html.floatWrapper.appendChild(this._html.wrapper),this.getPanes().floatPane.appendChild(this._html.floatWrapper);var a=this.getMap();this.clearListeners(),this._opts.closeOnMapClick&&this.trackListener(google.maps.event.addListener(a,"click",function(){e.close()})),this._opts.closeWhenOthersOpen&&this.trackListener(google.maps.event.addListener(a,"snazzy-info-window-opened",function(t){e!==t&&e.close()})),google&&(this._previousWidth=null,this._previousHeight=null,this.trackListener(google.maps.event.addListener(a,"bounds_changed",function(){var t=a.getDiv(),s=t.offsetWidth,i=t.offsetHeight,o=e._previousWidth,n=e._previousHeight;null!==o&&null!==n&&o===s&&n===i||(e._previousWidth=s,e._previousHeight=i,e.resize())})),this._marker&&this.trackListener(google.maps.event.addListener(this._marker,"position_changed",function(){e.draw()})),this._opts.showCloseButton&&!this._opts.closeButtonMarkup&&this.trackListener(google.maps.event.addDomListener(this._html.closeButton,"click",function(t){t.cancelBubble=!0,t.stopPropagation&&t.stopPropagation(),e.close()})),["click","dblclick","rightclick","contextmenu","drag","dragend","dragstart","mousedown","mouseout","mouseover","mouseup","touchstart","touchend","touchmove","wheel","mousewheel","DOMMouseScroll","MozMousePixelScroll"].forEach(function(t){e.trackListener(google.maps.event.addDomListener(e._html.wrapper,t,function(e){e.cancelBubble=!0,e.stopPropagation&&e.stopPropagation()}))})),this.activateCallback("open")}}},{key:"onRemove",value:function(){if(this.activateCallback("close"),this._html){var e=this._html.floatWrapper.parentElement;e&&e.removeChild(this._html.floatWrapper),this._html=null}this._isOpen=!1,this.activateCallback("afterClose")}},{key:"getMapInnerBounds",value:function(){var e=this.getMap().getDiv().getBoundingClientRect(),t={top:e.top+this._opts.edgeOffset.top,right:e.right-this._opts.edgeOffset.right,bottom:e.bottom-this._opts.edgeOffset.bottom,left:e.left+this._opts.edgeOffset.left};return t.width=t.right-t.left,t.height=t.bottom-t.top,t}},{key:"reposition",value:function(){if(this._opts.panOnOpen&&this._html){var e=this.getMapInnerBounds(),t=this._html.wrapper.getBoundingClientRect(),s=0,i=0;e.left>=t.left?s=t.left-e.left:e.right<=t.right&&(s=t.left-(e.right-t.width)),e.top>=t.top?i=t.top-e.top:e.bottom<=t.bottom&&(i=t.top-(e.bottom-t.height)),0===s&&0===i||this.getMap().panBy(s,i)}}},{key:"resize",value:function(){if(this._html){var e=this.getMapInnerBounds(),t=e.width;void 0!==this._opts.maxWidth&&(t=Math.min(t,this._opts.maxWidth)),t-=this._html.wrapper.offsetWidth-this._html.content.offsetWidth,this._html.content.style.maxWidth=t+"px";var s=e.height;void 0!==this._opts.maxHeight&&(s=Math.min(s,this._opts.maxHeight)),s-=this._html.wrapper.offsetHeight-this._html.content.offsetHeight,this._html.content.style.maxHeight=s+"px"}}}]),t}();t.default=f,e.exports=t.default});/*! Map Api Js Start*/
var vizyonIcon="Merkez_map_icon.png",sahilIcon="Sahil_map_icon.png",onIcon="On_map_icon.png",goztepeIcon="Goztepe_map_icon.png",businessIcon="Businesskar_map_icon.png",lokumIcon="Lokum_map_icon.png",adaIcon="Ada_map_icon.png",businessTuzlaIcon="Businesstuz_map_icon.png",suadiyeIcon="Suadiye_map_icon.png",erenkoyIcon="Erenkoy_map_icon.png",dkyVizyon=[["DKY Vizyon",40.9093863,29.1996109,"images/"+vizyonIcon,"#dkyVizyonLink","images/DKY-KARTAL-GECE.jpg",1]],dkySahil=[["DKY Sahil",40.8944685,29.171256,"images/"+sahilIcon,"#dkySahilLink","images/map-sahil.jpg",1]],dkyOnKagithane=[["DKY On Kağıthane",41.085888,28.9703857,"images/"+onIcon,"#dkyOnKagithaneLink","images/map-on.jpg",1]],dkyGoztepe=[["DKY Cadde Göztepe 05",40.9801883,29.0653588,"images/"+goztepeIcon,"#dkyGoztepeLink","images/map-goztepe.jpg",1]],dkyBusiness=[["DKY Business Kartal",40.909721,29.212279,"images/"+businessIcon,"#dkyBusinessLink","images/map-business.jpg",1]],dkyLokumEvler=[["Lokum Evler",40.8750308,29.3239722,"images/"+lokumIcon,"#dkyLokumEvlerLink","images/map-lokum.jpg",1]],dkyAda=[["DKY Ada",40.905396,29.185898,"images/"+adaIcon,"#dkyAdaLink","images/map-ada.jpg",1]],dkyBusinessTuzla=[["DKY Business Tuzla",40.847713,29.2967011,"images/"+businessTuzlaIcon,"#dkyBusinezzTuzlaLink","images/map-tuzla.jpg",1]],dkyCaddeSuadiye=[["DKY Cadde Suadiye 12",40.96679,29.085285,"images/"+suadiyeIcon,"#dkyCaddeSuadiyeLink","images/map-suadiye.jpg",1]],dkyCaddeErenkoy=[["DKY Cadde Erenköy 86",40.978263,29.073121,"images/"+erenkoyIcon,"#dkyCaddeErenkoyLink","images/map-erenkoy.jpg",1]],tamamlanan=[["DKY Cadde Erenköy 86",40.978263,29.073121,"images/"+erenkoyIcon,"#dkyCaddeErenkoyLink","images/DKY-KARTAL-GECE.jpg",1],["DKY Cadde Suadiye 12",40.96679,29.085285,"images/"+suadiyeIcon,"#dkyCaddeSuadiyeLink","images/DKY-KARTAL-GECE.jpg",1]],devamEden=dkyAda.concat(dkyBusinessTuzla),gelecek=dkySahil.concat(dkyVizyon,dkyOnKagithane,dkyGoztepe,dkyBusiness,dkyLokumEvler),hepsi=dkySahil.concat(dkyVizyon,dkyOnKagithane,dkyGoztepe,dkyBusiness,dkyLokumEvler,dkyAda,dkyBusinessTuzla,dkyCaddeErenkoy,dkyCaddeSuadiye),stls=[{featureType:"all",elementType:"geometry",stylers:[{color:"#25292e"}]},{featureType:"all",elementType:"labels.text.fill",stylers:[{gamma:.01},{lightness:20},{color:"#47546e"}]},{featureType:"all",elementType:"labels.text.stroke",stylers:[{saturation:-31},{lightness:-33},{weight:2},{gamma:"0.00"},{visibility:"off"}]},{featureType:"all",elementType:"labels.icon",stylers:[{visibility:"on"}]},{featureType:"administrative.country",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"administrative.province",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"administrative.locality",elementType:"all",stylers:[{visibility:"simplified"}]},{featureType:"administrative.locality",elementType:"labels.text.fill",stylers:[{lightness:"45"}]},{featureType:"administrative.locality",elementType:"labels.icon",stylers:[{visibility:"on"}]},{featureType:"administrative.neighborhood",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"administrative.land_parcel",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"landscape",elementType:"geometry",stylers:[{lightness:30},{saturation:30},{color:"#30363d"},{visibility:"on"}]},{featureType:"poi",elementType:"geometry",stylers:[{saturation:"0"},{lightness:"0"},{gamma:"0.30"},{weight:"0.01"},{visibility:"off"}]},{featureType:"poi.park",elementType:"geometry",stylers:[{lightness:"100"},{saturation:-20},{visibility:"simplified"},{color:"#32383d"}]},{featureType:"road",elementType:"geometry",stylers:[{lightness:10},{saturation:-30},{color:"#2a3037"}]},{featureType:"road",elementType:"geometry.stroke",stylers:[{saturation:"-100"},{lightness:"-100"},{gamma:"0.00"},{color:"#2a3037"}]},{featureType:"road",elementType:"labels",stylers:[{visibility:"on"}]},{featureType:"road",elementType:"labels.text",stylers:[{visibility:"on"},{color:"#575e6b"}]},{featureType:"road",elementType:"labels.text.stroke",stylers:[{visibility:"off"}]},{featureType:"road",elementType:"labels.icon",stylers:[{visibility:"on"},{weight:"1"},{gamma:"1"},{saturation:"100"},{lightness:"1"}]},{featureType:"road.highway",elementType:"geometry.fill",stylers:[{color:"#474b51"},{visibility:"on"},{weight:"0.78"}]},{featureType:"road.highway",elementType:"geometry.stroke",stylers:[{visibility:"off"},{weight:"1.06"}]},{featureType:"road.highway",elementType:"labels.icon",stylers:[{visibility:"on"},{saturation:"75"}]},{featureType:"road.highway.controlled_access",elementType:"labels.text",stylers:[{visibility:"on"}]},{featureType:"road.highway.controlled_access",elementType:"labels.icon",stylers:[{visibility:"on"},{hue:"#ff6600"},{lightness:"1"},{saturation:"100"},{gamma:"1"},{weight:"2.08"}]},{featureType:"road.arterial",elementType:"labels.icon",stylers:[{visibility:"on"}]},{featureType:"road.local",elementType:"labels.icon",stylers:[{hue:"#ff0000"},{visibility:"on"}]},{featureType:"transit",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"transit.station.airport",elementType:"all",stylers:[{visibility:"off"}]},{featureType:"water",elementType:"all",stylers:[{lightness:-20},{color:"#35485f"}]},{featureType:"transit.station.rail",elementType:"labels.icon",stylers:[{hue:"#1f2d79"},{visibility:"on"}]},{featureType:"poi.park",elementType:"labels.icon",stylers:[{color:"#7cb342"}]}],mapOpt={zoom:11,scrollwheel:!1,center:new google.maps.LatLng(hepsi[3][1],hepsi[1][2]),mapTypeId:google.maps.MapTypeId.ROADMAP,types:["hospital","school","shopping_mall","amusement_park","park","food","gym","mosque","subway_station","train_station","bus_station"],styles:stls},map=new google.maps.Map(document.getElementById("map"),mapOpt),marker,i,markers=[],infowindow;test(hepsi,map),runMap(".dky-sahil-harbtn",dkySahil,{lat:hepsi[3][1],lng:hepsi[1][2]},11),runMap(".dky-kartal-harbtn",dkyVizyon,{lat:hepsi[3][1],lng:hepsi[1][2]},11),runMap(".dky-on-harbtn",dkyOnKagithane,{lat:hepsi[3][1],lng:hepsi[1][2]},11),runMap(".dky-cadde-goztepe-harbtn",dkyGoztepe,{lat:hepsi[3][1],lng:hepsi[1][2]},11),runMap(".dky-bsness-kartal-harbtn",dkyBusiness,{lat:hepsi[3][1],lng:hepsi[1][2]},11),runMap(".dky-lokum-harbtn",dkyLokumEvler,{lat:hepsi[3][1],lng:hepsi[1][2]},11),runMap(".dky-ada-harbtn",dkyAda,{lat:hepsi[3][1],lng:hepsi[1][2]},11),runMap(".dky-bsness-tuzla-harbtn",dkyBusinessTuzla,{lat:hepsi[3][1],lng:hepsi[1][2]},11),runMap(".dky-cadde-suadiye-harbtn",dkyCaddeSuadiye,{lat:hepsi[3][1],lng:hepsi[1][2]},11),runMap(".dky-cadde-erenkoy-harbtn",dkyCaddeErenkoy,{lat:hepsi[3][1],lng:hepsi[1][2]},11),runMap(".tamamlanan-harbtn",tamamlanan,{lat:hepsi[3][1],lng:hepsi[1][2]},11),runMap(".devam-eden-harbtn",devamEden,{lat:hepsi[3][1],lng:hepsi[1][2]},11),runMap(".gelecek-harbtn",gelecek,{lat:hepsi[3][1],lng:hepsi[1][2]},11),runMap(".hepsi-harbtn",hepsi,{lat:hepsi[3][1],lng:hepsi[1][2]},11);var projeParentLink=".proje-listesi h4 a",pli=".dprojs li",plli=".dplaces li",hastane=0,okul=1,resmiKurum=2,avm=3,orman=4,ulasim=5,cami=6,park=7,yemek=8,spor=9;aktifs(),$(document).click(function(e){map.set("scrollwheel",!1)}),$("#map").click(function(e){e.stopPropagation(),map.set("scrollwheel",!0)});