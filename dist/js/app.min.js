...
//kurumsal side menu
$(window).width()>767&&$(".side-menu").height($(".content-inner").height()-60),$(function(){var e=location.pathname;$(".side-menu a").each(function(){var t=$(this),a=e.split(/[\s/]+/);
// if the current path is like this link, make it active
-1!==t.attr("href").indexOf(a[a.length-1])&&($(".side-menu a").removeClass("active"),t.addClass("active"))})});
