...
function addTxt(e,a){$(bullts+":eq("+(e-1)+")").html('<div class="res">'+a+"</div>")}$(".menu-toggle").click(function(){$(".menu").toggleClass("opened"),$(this).toggleClass("active"),$(".header").toggleClass("static")});
//Slider
var activeClassTxt=".swiper-pagination-bullet-active .res",bullts=".swiper-pagination-bullet",swiper=new Swiper(".swiper-container",{direction:"vertical",watchSlidesProgress:!0,pagination:".swiper-pagination",paginationClickable:!0,keyboardControl:!0,
//effect: "fade",
speed:1e3,loop:!0,autoplay:3e3,queueStartCallbacks:!0,onInit:function(e){setTimeout(function(){addTxt(1,"DKY Sahil"),addTxt(2,"DKY On"),addTxt(3,"DKY Kartal"),$(activeClassTxt).show()},500)},onAfterResize:function(e){addTxt(1,"DKY Sahil"),addTxt(2,"DKY On"),addTxt(3,"DKY Kartal"),$(activeClassTxt).show()},onSlideChangeStart:function(e){$(".res").hide(),$(activeClassTxt).show()}}),searchButon=".languages .search-btn",searchDiv=".search",closeButon=".close-search";$(searchButon).click(function(){$(searchDiv).addClass("opened")}),$(closeButon).click(function(){$(searchDiv).removeClass("opened")});
