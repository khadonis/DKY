...
//menu panel
function addTxt(e,i){$(bullts+":eq("+(e-1)+")").html('<div class="res">'+i+"</div>")}
...
function resizes(e){$(e).each(function(){var e=$(this).width(),i=$(this).parent().width();$(this).height(e),$(this).parent().height(i),$(this).find("img").height(e)})}$(".menu-toggle").click(function(){$(".menu").toggleClass("opened"),$(this).toggleClass("active"),$(".header").toggleClass("static")});
//Sliders
