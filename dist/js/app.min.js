...
//menu panel
function addTxt(e,t){$(bullts+":eq("+(e-1)+")").html('<div class="res">'+t+"</div>")}$(".menu-toggle").click(function(){$(".menu").toggleClass("opened"),$(this).toggleClass("active"),$(".header").toggleClass("static")});
//Sliders
...
-1!==t.attr("href").indexOf(i[i.length-1])&&($(".side-menu a").removeClass("active"),t.addClass("active"))})}),
...
$(".tp-box-field a").each(function(){var e=$(this).width(),t=$(this).parent().width();$(this).height(e),$(this).parent().height(t),$(this).find("img").height(e)});
