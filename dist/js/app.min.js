...
autoplay:3e3,loop:!0}),swiperHaberler=new Swiper(".basin-slide-container",{speed:400,nextButton:".swiper-haber-btn-next",prevButton:".swiper-haber-btn-prev",slidesPerView:3,spaceBetween:30,autoplay:2e3,loop:!0,breakpoints:{767:{slidesPerView:1,spaceBetween:0}}}),searchButon=".languages .search-btn",searchDiv=".search",closeButon=".close-search";$(searchButon).click(function(){$(searchDiv).addClass("opened")}),$(closeButon).click(function(){$(searchDiv).removeClass("opened")}),
//video
$(".video-wrapper .mask").click(function(e){$(".video").attr("src","https://www.youtube.com/embed/hAxZF94QFks?autoplay=1").siblings().hide()}),
//kurumsal side menu
$(".side-menu").height($(".content-inner").height()-60),$(function(){var e=location.pathname;$(".side-menu a").each(function(){var t=$(this),a=e.split(/[\s/]+/);
