...
>>>>>>> proje detay sayfasında harita sekmesi üzerinde çalışılıyor. haritalar oluşturulabilir durumda. harita ikonları ve lokasyon bilgileri girilecek...
/*!
...
onSlideChangeStart:function(){$(".kartal-galeri .head div").find("a").removeClass("active"),$(".kartal-galeri .head div").eq(swiperKrtlGaleri.activeIndex).find("a").addClass("active")},spaceBetween:40}),swiperKrtlMimari=new Swiper(".kg-mimari-slider-container",{speed:400,nextButton:".kg-btn-next",prevButton:".kg-btn-prev",spaceBetween:40}),swiperKrtlIcMimari=new Swiper(".kg-icmimari-slider-container",{speed:400,nextButton:".kg-btn-next",prevButton:".kg-btn-prev",spaceBetween:40}),swiperKrtlODaire=new Swiper(".kg-odaire-slider-container",{speed:400,nextButton:".kg-btn-next",prevButton:".kg-btn-prev",spaceBetween:40}),swiperKrtlPlans=new Swiper(".plans-slider-container",{speed:400,spaceBetween:40,onSlideChangeStart:function(){$(".plans-menu li").find("a").removeClass("active"),$(".plans-menu li").eq(swiperKrtlPlans.activeIndex).find("a").addClass("active")}}),swiperKrtlPlan1=new Swiper(".plan-1-slide-container",{speed:400,
//direction:'vertical',
